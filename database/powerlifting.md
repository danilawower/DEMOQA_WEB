...
2. `объёмно-силовой` 
3. `выход на пик` 
Для простоты примера, предлагаю перевести эти понятия на более привычные, по шкале интенсивности: `лёгкая тренировка`, `средняя тренировка`, `тяжёлая тренировка`
